...
mds_plot<-ggplot(mds, aes(x = `1`, y = `2`, color = age)) +
    geom_point(size = 4) + coord_fixed() + ggtitle("MDS Age") + 
...
mds_plot<-ggplot(mds, aes(x = `1`, y = `2`, color = Reads)) +
    geom_point(size = 4) + coord_fixed() + ggtitle("MDS Reads %") + 
    scale_color_gradientn(colours = rainbow(6)) +
    theme(
        panel.background = element_rect(fill='transparent'),
        plot.background = element_rect(fill='transparent', color=NA),
...
shortreads<-cross2$Short_reads

mds_plot<-ggplot(mds, aes(x = `1`, y = `2`, color = shortreads)) +
    geom_point(size = 4) + coord_fixed() + ggtitle("MDS Short reads %") + 
    scale_color_gradientn(colours = rainbow(6)) +
    theme(
        panel.background = element_rect(fill='transparent'),
        plot.background = element_rect(fill='transparent', color=NA),
...
ushort_reads<-cross2$ushort_reads

mds_plot<-ggplot(mds, aes(x = `1`, y = `2`, color = ushort_reads)) +
    geom_point(size = 4) + coord_fixed() + ggtitle("MDS Ultra short reads %") + 
    scale_color_gradientn(colours = rainbow(6)) +
    theme(
        panel.background = element_rect(fill='transparent'),
        plot.background = element_rect(fill='transparent', color=NA),
...
bacteria_reads<-cross2$bacteria_reads

mds_plot<-ggplot(mds, aes(x = `1`, y = `2`, color = bacteria_reads)) +
    geom_point(size = 4) + coord_fixed() + ggtitle("MDS Bacteria reads %") + 
    scale_color_gradientn(colours = rainbow(6)) +
    theme(
        panel.background = element_rect(fill='transparent'),
        plot.background = element_rect(fill='transparent', color=NA),
...
virus_reads<-cross2$virus_reads

mds_plot<-ggplot(mds, aes(x = `1`, y = `2`, color = virus_reads)) +
    geom_point(size = 4) + coord_fixed() + ggtitle("MDS Virus reads %") + 
    scale_color_gradientn(colours = rainbow(6)) +
    theme(
        panel.background = element_rect(fill='transparent'),
        plot.background = element_rect(fill='transparent', color=NA),
