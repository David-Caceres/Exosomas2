...
test<-test[- grep("Unknown", test$Proven_nephritis),]

training$Proven_nephritis <- factor(training$Proven_nephritis, levels = c("No","Yes"))
test$Proven_nephritis <- factor(test$Proven_nephritis, levels = c("No","Yes"))
...
pred <- predict(object = model,
                        ...
                        type = "prob")
# Cálculo de la curva
curva_roc_rf <- roc(response = test$Proven_nephritis, 
                 predictor = pred$Yes) 
...
pred <- predict(object = model_svm,
                        ...
                        type = "prob")
# Cálculo de la curva
curva_roc_svm <- roc(response = test$Proven_nephritis, 
                 predictor = pred$Yes) 
...
pred <- predict(object = model_knn,
                        ...
                        type = "prob")
# Cálculo de la curva
curva_roc_knn <- roc(response = test$Proven_nephritis, 
                 predictor = pred$Yes) 
...
pred <- predict(object = model_nb,
                        ...
                        type = "prob")
# Cálculo de la curva
curva_roc_nb <- roc(response = test$Proven_nephritis, 
                 predictor = pred$Yes) 
...
confusionMatrix(test$Proven_nephritis, pred, positive = "Yes")
...
set.seed(3456)
trainIndex <- createDataPartition(training$Proven_nephritis, p = 0.75,  
                                  list = FALSE, 
                                  times = 10)


Train2 <- training[ trainIndex,]
Test2  <- training[-trainIndex,]
```
