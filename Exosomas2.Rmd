...
cross_no_micro[is.na(cross_no_micro)] <- "Unknown"

cross_no_micro_SLE$sex<-factor(cross_no_micro_SLE$Sex, levels=c("Male","Female"),labels=c(0,1))

cross_no_micro_SLE$Symptom_Abnormal.inflammatory.indexes2<-factor(cross_no_micro_SLE$Symptom_Abnormal.inflammatory.indexes, levels=c("No", "Unknown","Past","Present"), labels=c(-2, 0, -1, 1))

cross_no_micro_SLE$Kidney_Abnormal.Creatinine2<-factor(cross_no_micro_SLE$Kidney_Abnormal.Creatinine, levels=c("No", "Unknown", "Past","Present"), labels=c(-2, 0, -1, 1)) 

cross_no_micro_SLE$Kidney_Abnormal.lipid.profile2<-factor(cross_no_micro_SLE$Kidney_Abnormal.lipid.profile, levels=c("No", "Unknown", "Past","Present"), labels=c(-2, 0, -1, 1))

cross_no_micro_SLE$Kidney_Abnormal.urine.analysis2<-factor(cross_no_micro_SLE$Kidney_Abnormal.urine.analysis, levels=c("No", "Unknown","Past","Present"), labels=c(-2, 0, -1, 1))

cross_no_micro_SLE$Kidney_Proteinuria2<-factor(cross_no_micro_SLE$Kidney_Proteinuria, levels=c("No", "Unknown", "Past","Moderate","Severe"), labels=c(-2, 0, -1,1, 1))

cross_no_micro_SLE$Lab_Reduced.C3.levels2<-factor(cross_no_micro_SLE$Lab_Reduced.C3.levels, levels=c("No", "Unknown", "Past","Present"), labels=c(-2, 0, -1, 1))

Lab_Reduced.C4.levels2<-factor(cross_no_micro_SLE$Lab_Reduced.C4.levels, levels=c("No", "Unknown", "Past","Present"), labels=c(-2, 0,  -1, 1))
...
mtry_rf<-list()
for (i in 1:20){
mtry_rf[[i]]<-models.sub[[i]]$modelRF$bestTune
}
...
mtry_svm<-list()
for (i in 1:20){
mtry_svm[[i]]<-models.sub[[i]]$modelSVM$bestTune
}
mtry_svm<- do.call(rbind, mtry_svm)

tabla<-cbind(mtry,auc,mtry_svm,auc_svm)
...
mtry_knn<-list()
for (i in 1:20){
mtry_knn[[i]]<-models.sub[[i]]$modelKNN$bestTune
}
mtry_knn<- do.call(rbind, mtry_knn)

tabla<-cbind(mtry,auc,mtry_svm,auc_svm,mtry_knn,auc_knn)
...
mtry_nb<-list()
for (i in 1:20){
mtry_nb[[i]]<-models.sub[[i]]$modelNB$bestTune
}
mtry_nb<- do.call(rbind, mtry_nb)

tabla<-cbind(mtry_rf,auc_rf,mtry_svm,auc_svm,mtry_knn,auc_knn,mtry_nb[3],auc_nb)
