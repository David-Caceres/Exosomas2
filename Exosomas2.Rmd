...
colnames(cross_sec3)[colnames(cross_sec3) == "Diagnosis.x"] <- "Diagnosis"
cross_sec3<-cross_sec3[,-20]
...
cross_lupus$Symptom_Abnormal.inflammatory.indexes2<-factor(cross_lupus$Symptom_Abnormal.inflammatory.indexes, levels=c("No", "Unknown", "Yes","Past","Present"), labels=c(-1, 0, 1, 1, 2))

cross_lupus$Kidney_Abnormal.Creatinine2<-factor(cross_lupus$Kidney_Abnormal.Creatinine, levels=c("No", "Unknown", "Yes","Past","Present"), labels=c(-1, 0, 1, 1, 2))

cross_lupus$Kidney_Abnormal.lipid.profile2<-factor(cross_lupus$Kidney_Abnormal.lipid.profile, levels=c("No", "Unknown", "Yes","Past","Present"), labels=c(-1, 0, 1, 1, 2))

cross_lupus$Kidney_Abnormal.urine.analysis2<-factor(cross_lupus$Kidney_Abnormal.urine.analysis, levels=c("No", "Unknown", "Yes","Past","Present"), labels=c(-1, 0, 1, 1, 2))

cross_lupus$Kidney_Proteinuria2<-factor(cross_lupus$Kidney_Proteinuria, levels=c("No", "Unknown", "Past","Moderate","Severe"), labels=c(-1, 0, 1, 1, 2))

cross_lupus$Lab_Reduced.C3.levels2<-factor(cross_lupus$Lab_Reduced.C3.levels, levels=c("No", "Unknown", "Yes","Past","Present"), labels=c(-1, 0, 1, 1, 2))

cross_lupus$Lab_Reduced.C4.levels2<-factor(cross_lupus$Lab_Reduced.C4.levels, levels=c("No", "Unknown", "Yes","Past","Present"), labels=c(-1, 0, 1, 1, 2))


# Tabla final

lupus_modelo<-data_frame(cross_lupus$Kidney_Biopsy.proven.nephritis,cross_lupus$sex,cross_lupus$Symptom_Abnormal.inflammatory.indexes2,cross_lupus$Kidney_Abnormal.Creatinine2, cross_lupus$Kidney_Abnormal.lipid.profile2,cross_lupus$Kidney_Abnormal.urine.analysis2,cross_lupus$Kidney_Proteinuria2,cross_lupus$Lab_Reduced.C3.levels2,cross_lupus$Lab_Reduced.C4.levels2, cross_lupus$Symptom_Disease.activity)

colnames(lupus_modelo)<-c("Proven_nephritis", "Sex", "Inflammatory", "Creatinine", "lipid", "Urine", "Proteinuria", "C3_levels", "C4_levels","Activity")
...
cross_no_micro_SLE<-cross_no_micro[cross_no_micro$Diagnosis == "SLE",]
...
```{r}
# Transformo los datos sin micros y SLE+



cross_no_micro_SLE$sex<-factor(cross_no_micro_SLE$Sex, levels=c("Male","Female"),labels=c(0,1))

cross_no_micro_SLE$Symptom_Abnormal.inflammatory.indexes2<-factor(cross_no_micro_SLE$Symptom_Abnormal.inflammatory.indexes, levels=c("No", "Unknown", "Yes","Past","Present"), labels=c(-1, 0, 1, 1, 2))

cross_no_micro_SLE$Kidney_Abnormal.Creatinine2<-factor(cross_no_micro_SLE$Kidney_Abnormal.Creatinine, levels=c("No", "Unknown", "Yes","Past","Present"), labels=c(-1, 0, 1, 1, 2))

cross_no_micro_SLE$Kidney_Abnormal.lipid.profile2<-factor(cross_no_micro_SLE$Kidney_Abnormal.lipid.profile, levels=c("No", "Unknown", "Yes","Past","Present"), labels=c(-1, 0, 1, 1, 2))

cross_no_micro_SLE$Kidney_Abnormal.urine.analysis2<-factor(cross_no_micro_SLE$Kidney_Abnormal.urine.analysis, levels=c("No", "Unknown", "Yes","Past","Present"), labels=c(-1, 0, 1, 1, 2))

cross_no_micro_SLE$Kidney_Proteinuria2<-factor(cross_no_micro_SLE$Kidney_Proteinuria, levels=c("No", "Unknown", "Past","Moderate","Severe"), labels=c(-1, 0, 1, 1, 2))

cross_no_micro_SLE$Lab_Reduced.C3.levels2<-factor(cross_no_micro_SLE$Lab_Reduced.C3.levels, levels=c("No", "Unknown", "Yes","Past","Present"), labels=c(-1, 0, 1, 1, 2))

cross_no_micro_SLE$Lab_Reduced.C4.levels2<-factor(cross_no_micro_SLE$Lab_Reduced.C4.levels, levels=c("No", "Unknown", "Yes","Past","Present"), labels=c(-1, 0, 1, 1, 2))
...
lupus_modelo_no_micros<-data_frame(cross_no_micro_SLE$Kidney_Biopsy.proven.nephritis,cross_no_micro_SLE$sex,cross_no_micro_SLE$Symptom_Abnormal.inflammatory.indexes2,cross_no_micro_SLE$Kidney_Abnormal.Creatinine2, cross_no_micro_SLE$Kidney_Abnormal.lipid.profile2,cross_no_micro_SLE$Kidney_Abnormal.urine.analysis2,cross_no_micro_SLE$Kidney_Proteinuria2,cross_no_micro_SLE$Lab_Reduced.C3.levels2,cross_no_micro_SLE$Lab_Reduced.C4.levels2, cross_no_micro_SLE$Symptom_Disease.activity)

colnames(lupus_modelo_no_micros)<-c("Proven_nephritis", "Sex", "Inflammatory", "Creatinine", "lipid", "Urine", "Proteinuria", "C3_levels", "C4_levels","Activity")

head(lupus_modelo)
head(lupus_modelo_no_micros)

write.table(lupus_modelo, file = "/home/david_caceres/Exosomas/Exosomas2/Tablas/lupus_modelo.tsv", append = FALSE, quote = TRUE, sep = "\t ")
write.table(lupus_modelo_no_micros, file = "/home/david_caceres/Exosomas/Exosomas2/Tablas/lupus_modelo_no_micros.tsv", append = FALSE, quote = TRUE, sep = "\t ")
...
```{r}
test<-read.table(file="/home/david_caceres/Exosomas/Exosomas2/Tablas/lupus_modelo.tsv", header = TRUE, sep = "\t")
training<-read.table(file="/home/david_caceres/Exosomas/Exosomas2/Tablas/lupus_modelo_no_micros.tsv", header = TRUE, sep = "\t")


training$Proven_nephritis<-as.factor(training$Proven_nephritis)
test$Proven_nephritis<-as.factor(test$Proven_nephritis)
...
library(plyr)
training$Proven_nephritis<-revalue(training$Proven_nephritis, c(" No"="No", " Unknown"="Unknown", " Yes" = "Yes"))
test$Proven_nephritis<-revalue(test$Proven_nephritis, c(" No"="No", " Unknown"="Unknown", " Yes" = "Yes"))

# Quito los unknown de los datos de entrenamiento

training<-training[- grep("Unknown", training$Proven_nephritis),]

write.table(training, file = "/home/david_caceres/Exosomas/Exosomas2/Tablas/training.tsv", append = FALSE, quote = TRUE, sep = "\t ")

training<-read.table(file="/home/david_caceres/Exosomas/Exosomas2/Tablas/training.tsv", header = TRUE, sep = "\t")
...
ind2 <-sample(2, nrow(training),replace=T, prob = c(0.75, 0.25))

train2 <- training[ind2 == 1,]
test2 <- training[ind2 == 2,]


set.seed(63214)

ind3 <-sample(2, nrow(training),replace=T, prob = c(0.75, 0.25))

train3 <- training[ind3 == 1,]
test3 <- training[ind3 == 2,]


set.seed(568)

ind4 <-sample(2, nrow(training),replace=T, prob = c(0.75, 0.25))

train4 <- training[ind4 == 1,]
test4 <- training[ind4 == 2,]

set.seed(25842)

ind4 <-sample(2, nrow(training),replace=T, prob = c(0.75, 0.25))

train5 <- training[ind5 == 1,]
test5 <- training[ind5 == 2,]

set.seed(25842)

ind6 <-sample(2, nrow(training),replace=T, prob = c(0.75, 0.25))

train6 <- training[ind6 == 1,]
test6 <- training[ind6 == 2,]

set.seed(111)

ind7 <-sample(2, nrow(training),replace=T, prob = c(0.75, 0.25))

train7 <- training[ind7 == 1,]
test7<- training[ind7 == 2,]

set.seed(41859)

ind8 <-sample(2, nrow(training),replace=T, prob = c(0.75, 0.25))

train8 <- training[ind8 == 1,]
test8<- training[ind8 == 2,]


set.seed(419)

ind9 <-sample(2, nrow(training),replace=T, prob = c(0.75, 0.25))

train9 <- training[ind9 == 1,]
test9<- training[ind9 == 2,]

set.seed(2020)

ind10 <-sample(2, nrow(training),replace=T, prob = c(0.75, 0.25))

train10 <- training[ind10 == 1,]
test10<- training[ind10 == 2,]

set.seed(13)

ind11 <-sample(2, nrow(training),replace=T, prob = c(0.75, 0.25))

train11 <- training[ind10 == 1,]
test11<- training[ind10 == 2,]


train<-rbind(train2,train3,train4,train5,train6,train7,train8,train9,train10,train11)
test<-rbind(test2,test3,test4,test5,test6,test7,test8,test9,test10,test11)
...
train$Proven_nephritis<-as.factor(train$Proven_nephritis) 
train$Proven_nephritis<-revalue(train$Proven_nephritis, c(" No"="No",  " Yes" = "Yes"))
...
model_svm <- train(Proven_nephritis ~ .,
             data = train,
             method = 'svmLinear',
             tuneLength = 20,
             trControl = trControl,
...
model_knn <- train(Proven_nephritis ~ .,
             data = train,
             method = 'knn',
             tuneLength = 20,
             trControl = trControl,
...
model_nb <- train(Proven_nephritis ~ .,
             data = train,
             method = 'naive_bayes',
             tuneLength = 20,
             trControl = trControl,
...
pred <- predict(object = model,
                        ...
                        type = "prob")
# Cálculo de la curva
curva_roc_rf <- roc(response = test3$Proven_nephritis, predictor = pred$Yes) 


p1<-plot(curva_roc_rf, main= "Random Forest", col="red", print.auc=TRUE)
...
# Se obtienen las probabilidades predichas para cada clase
pred <- predict(object = model_svm,
                        newdata = test3,
                        type = "prob")
# Cálculo de la curva
curva_roc_svm <- roc(response = test3$Proven_nephritis, 
                 predictor = pred$Yes) 


p2<-plot(curva_roc_svm, main= "SVM", col="red", print.auc=TRUE)
...
# Se obtienen las probabilidades predichas para cada clase
pred <- predict(object = model_knn,
                        newdata = test3,
                        type = "prob")
# Cálculo de la curva
curva_roc_knn <- roc(response = test3$Proven_nephritis, 
                 predictor = pred$Yes) 


p3<-plot(curva_roc_knn, main= "kNN", col="red", print.auc=TRUE)

plot(model_knn)


# Se obtienen las probabilidades predichas para cada clase
pred <- predict(object = model_nb,
                        newdata = test3,
                        type = "prob")
# Cálculo de la curva
curva_roc_nb <- roc(response = test3$Proven_nephritis, 
                 predictor = pred$Yes) 


p4<-plot(curva_roc_nb, main= "NB", col="red", print.auc=TRUE)
...
saveRDS(model_svm2, "model_svm2.rds")
model_svm2<- readRDS("model_svm2.rds")

saveRDS(model_knn2, "model_knn2.rds")
model_knn2<- readRDS("model_knn2.rds")

saveRDS(model_nb2, "model_nb2.rds")
model_nb2 <- readRDS("model_nb2.rds")
...
pred2 <- predict(object = model2,
                        ...
                        type = "prob")
# Cálculo de la curva
curva_roc_rf2 <- roc(response = test3$Proven_nephritis, predictor = pred2$Yes) 


p1<-plot(curva_roc_rf2, main= "Random Forest", col="red", print.auc=TRUE)
...
# Se obtienen las probabilidades predichas para cada clase
pred2 <- predict(object = model_svm2,
                        newdata = test3,
                        type = "prob")
# Cálculo de la curva
curva_roc_svm2 <- roc(response = test3$Proven_nephritis, 
                 predictor = pred2$Yes) 


p2<-plot(curva_roc_svm2, main= "SVM", col="red", print.auc=TRUE)
...
# Se obtienen las probabilidades predichas para cada clase
pred2 <- predict(object = model_knn2,
                        newdata = test3,
                        type = "prob")
# Cálculo de la curva
curva_roc_knn2 <- roc(response = test3$Proven_nephritis, 
                 predictor = pred2$Yes) 


p3<-plot(curva_roc_knn2, main= "kNN", col="red", print.auc=TRUE)

plot(model_knn2)


# Se obtienen las probabilidades predichas para cada clase
pred2 <- predict(object = model_nb2,
                        newdata = test3,
                        type = "prob")
# Cálculo de la curva
curva_roc_nb2 <- roc(response = test3$Proven_nephritis, 
                 predictor = pred2$Yes) 


p4<-plot(curva_roc_nb2, main= "NB", col="red", print.auc=TRUE)
...
confusionMatrix(as.factor(test3$Proven_nephritis), pred2, positive = "Yes")
